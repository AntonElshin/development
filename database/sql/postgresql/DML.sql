...
-- select nextval('distance_seq');

insert into distance (race_id, distance_name, entrance_fee, entrance_currency, racer_limit_left) values
    (1, 'FULL', 1400.00, 'RUB', null);

-- inserts into registration

-- select nextval('registration_seq');
