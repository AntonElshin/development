...
-- обновляем признак активности забега одной записи по идентификатору
...
-- обновляем название забега одной записи по идентификатору
...
-- обновляем город забега одной записи по идентификатору
...
-- обновляем адрес забега одной записи по идентификатору
...
-- обновляем описание забега одной записи по идентификатору
...
-- обновляем все комбинации полей: 2 пары, 3 пары, 4 пары одной записи по идентификатору
